...
<body>
    ...
    <div id="toolbar">
        ...
        <a href="reportes/reporte.php" class="easyui-linkbutton" iconCls="icon-print" plain="true" target="_blank">Generar Reporte PDF</a>
        <a href="reportes/reporteJasper.php" class="easyui-linkbutton" iconCls="icon-print" plain="true" target="_blank">Generar Reporte Jasper</a>
